...
void robot_draw(Robot *r) {
    ...
    int cx = px + r->maze->tile_size/2;
    int cy = py + r->maze->tile_size/2;
    int rad = r->maze->tile_size/3;
    setColour(blue);
